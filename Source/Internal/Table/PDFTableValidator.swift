...
enum PDFTableValidator {
     ...
     */
    static func validateTable(table: PDFTable) throws {
     ...
     */
    static func validateTableData(data: [[Any?]], alignments: [[PDFTableCellAlignment]]? = nil, columnWidths: [CGFloat]? = nil) throws {
        // Throw error when empty. Signalizes developer he tries to render an empty table. Might cause format errors
        if data.isEmpty {
            throw PDFError.tableIsEmpty
        }
