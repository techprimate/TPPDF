...
class PDFImageObject: PDFObject {
    ...
    override func calculate(generator: PDFGenerator, container: PDFContainer) throws {
        ...
        let x: CGFloat = {
            ...
            case .headerLeft, .contentLeft, .footerLeft:
                return generator.document.layout.margin.side + generator.indentation[container.normalize]!
            case .headerCenter, .contentCenter, .footerCenter:
                return generator.document.layout.pageBounds.midX - imageSize.width / 2
            case .headerRight, .contentRight, .footerRight:
                return generator.document.layout.pageBounds.width - generator.document.layout.margin.side - imageSize.width
            default:
                return 0
            }
        }()
    ...
    override func draw(generator: PDFGenerator, container: PDFContainer) throws {
        let compressedImage = PDFGraphics.resizeAndCompressImage(image: image.image, frame: frame, quality: generator.imageQuality)
