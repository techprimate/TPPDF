...
extension PDFGenerator {
    ...
    open func setPageNumbering(_ container: Container = Container.none, style: PDFPaginationStyle = PDFPaginationStyle.Default, from fromPage: Int = 0, to toPage: Int = Int.max, hiddenPages: [Int] = []) {
