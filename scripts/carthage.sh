...
# Documentation: https://github.com/Carthage/Carthage/blob/main/Documentation/Xcode12Workaround.md
...
{
    echo "EXCLUDED_ARCHS__EFFECTIVE_PLATFORM_SUFFIX_simulator__NATIVE_ARCH_64_BIT_x86_64__XCODE_1200__BUILD_$CURRENT_XCODE_VERSION = arm64 arm64e armv7 armv7s armv6 armv8"
